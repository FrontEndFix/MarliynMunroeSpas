...
(function (App) {
    ...
    (function (Controller) {
        var HomeController = (function (_super) {
            ...
            function HomeController(appService, $rootScope, storageService, $location) {
                var _this = this;
                ...
                this.gotoElement = function (eID) {
                    var newHash = '#' + eID;
                    _this.tab = eID;
                    jQuery('.mun-box').animate({
                        scrollTop: jQuery(newHash).offset().top
                    }, 2000);
                };
                this.comingsoon = function () {
                    _this.appService.routerService.routeToPage('comingsoon');
                };
            ...
            HomeController.$inject = ['baseAppService', '$rootScope', 'storageService', '$location'];
